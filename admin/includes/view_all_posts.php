...
<table class="table table-hover table-bordered">
    ...
    $query .= " categories.cat_id, categories.cat_title FROM posts LEFT JOIN categories ON posts.post_category_id = categories.cat_id WHERE posts.post_user = '$user' ORDER BY posts.post_id DESC";
    ...
    while($row = mysqli_fetch_assoc($select_posts)) {
        ...
        echo "<td><img width='100' class='img-thumbnail img-responsive' src='../images/$post_image'</td>";
